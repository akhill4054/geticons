...
class IconSetListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_ICON_SET) {
            IconSetItemViewHolder.from(parent, _itemClickListener)
        } else {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is IconSetItemViewHolder) {
    ...
    private class IconSetItemViewHolder(
        ...
        companion object {
            fun from(
                ...
                return IconSetItemViewHolder(binding, itemClickListener)
            }
        }
    }

    private class ProgressItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
